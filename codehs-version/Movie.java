...
// Last edited on December 10th by River Chan
...
public class Movie {
    ...
    private String imagePath; //Update code to add this field! - River 
    ...
    * Returns a string of movie data (to be used for GUI, potentially)
    */
