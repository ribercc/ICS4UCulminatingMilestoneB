 ...
 * Last edited by Eva Lafontaine on Dec 8
 */
...
public class ReviewManager{
    ...
    public static Review writeAReview(Movie currentMovie, int movieIndex) { //!! Will return a review
        ...
        if (result == JOptionPane.OK_OPTION) {
            System.out.println(combo.getSelectedItem() + "\n " + ratingTextArea.getText()); // !test
            int starIndex = combo.getSelectedIndex(); // ! use int to enum method here
    ...
    public static String reviewToCSV(Review currentReview){
        ...
        reviewString.append(currentReview.getReviewName()).append("*"); //username
    ...
    /**
     * reads in the Reviews.csv file and stores each piece of info in the correct index of a Review object, stored as an ArrayList;
     * By Eva
    ...
    public static ArrayList <Review> readReviews ()throws IOException{
        ...
        if (file.exists()){
            ...
            while (fileReader.hasNext()){
                ...
                Review tempValue = new Review (reviewUserName, score, writtenReview, movieName, movieIndex);
    ...
    public static double calculateAvgStars(int movieIndex) throws IOException {
        ...
        for (int n = 0; n < allReviews.size(); n++) {
            ...
            if (allReviews.get(n).getMovieIndex()==movieIndex) {
                ...
                totalPoints += starToInt(allReviews.get(n).getScore());
                counter++;
            }
        }
