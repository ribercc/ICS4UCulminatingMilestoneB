...
public class MoviePage extends JPanel{
    ...
    public MoviePage(JPanel mainPanel, Font mainText) throws IOException{
       ...
       //Basic buttons to return to homepage
        ...
        returnHomepageButton.setBounds(100,750,171,30);
        ...
        yourRating.setBounds(200, 500, 300, 400);
        yourRating.setFont(mainText);
        add(yourRating);

        //determine amount of stars
        int rating = 0; //star rating value, switch to customer variable later
        ...
        starLabel.setBounds(200, 520, 300, 400);
        add(starLabel);

        //opens review pane to write a review
        JButton writeReview = new JButton("Write a review");
        writeReview.setBounds(280, 750, 171, 30);
